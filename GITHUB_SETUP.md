...
1. Go to https://github.com/Abhi-kairon
...
```bash
git remote set-url origin git@github.com:Abhi-kairon/CodeX.git
git push -u origin main
```

## Verify

After pushing, visit: https://github.com/Abhi-kairon/CodeX
